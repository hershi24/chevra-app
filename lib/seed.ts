  ...
  const messages: Message[] = [
    {
      ...
      authorId: "m-david",
      text: "חברים, המפגש הבא בבית שלנו ביום רביעי ב־20:30. משה יגיד שיעור על אהבת ישראל.",
    ...
    },
    {
      ...
      channelId: "c-general",
      authorId: "m-yossi",
      text: "איזה מפגש היה בפעם הקודמת. עדיין חושב על מה שמשה אמר על הקשבה בבית.",
