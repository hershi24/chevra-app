  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-10 md:gap-14">
      ...
      {event ? (
        ...
        <section className="paper-card rounded-[1.75rem] px-6 py-12 ring-1 ring-black/12">
...
function HeroEvent({
  ...
  return (
    <motion.section
      ...
      className="paper-card grid min-w-0 gap-8 rounded-[1.75rem] px-5 py-7 ring-1 ring-black/12 md:px-10 md:py-10 lg:grid-cols-[1fr_15.5rem] lg:gap-12"
    >
